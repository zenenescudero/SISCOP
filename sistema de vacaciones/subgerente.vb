...
Public Class subgerente
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            ...
            Dim agrega As String = "update subgerente set nombre=@nombre where id='" & Gridempleados.Item(0, Gridempleados.CurrentRow.Index).Value & "'"
            Dim comando As New MySqlCommand(agrega, coneccion)
            comando.CommandType = CommandType.Text
            comando.Parameters.AddWithValue("@nombre", TxtNom.Text)
            comando.ExecuteNonQuery()
            coneccion.Close()
            MsgBox("Modificado Corectamente", vbInformation, "SubGerente")
            consultar("select * from subgerente")
    ...
    Public Sub generarestructura()
        ...
        Gridempleados.Columns("nombre").HeaderText = "      SubGerente"
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Try
            ...
            Dim dset As New DataSet
            Dim dadaptador As New MySqlDataAdapter
            dadaptador.SelectCommand = New MySqlCommand("select count(subgerente) from colaborador where subgerente='" & Gridempleados.Item(0, Gridempleados.CurrentRow.Index).Value & "'", coneccion)
            dadaptador.Fill(dset)
            coneccion.Close()
        ...
        If MsgBox("Estas Seguro de Eliminar", MsgBoxStyle.OkCancel, "Confirmación") = MsgBoxResult.Ok Then
            If seborra = 0 Then
                Try
                    ...
                    coneccion.Open()
                    'nueva forma de agregar
                    Dim agrega As String = "delete from subgerente where id='" & Gridempleados.Item(0, Gridempleados.CurrentRow.Index).Value & "'"
                    Dim comando As New MySqlCommand(agrega, coneccion)
                    comando.CommandType = CommandType.Text
                ...
                End Try
            Else
                MsgBox(" No se puede Eliminar devido a que exiten colaboradores con este subgerente regisrado" & Chr(13) & "SUGERENCIA: Intenta modificar el nombre del subgerente...", MsgBoxStyle.Critical, "Error del Sistema")
            End If
        End If
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        Try
            ...
            coneccion.Open()
            'nueva forma de agregar
            Dim agrega As String = "insert into subgerente values(default,@nombre)"
            Dim comando As New MySqlCommand(agrega, coneccion)
            comando.CommandType = CommandType.Text
