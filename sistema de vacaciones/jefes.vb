...
Public Class jefes
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            ...
            Dim agrega As String = "update jefes set nombre=@nombre where id='" & Gridempleados.Item(0, Gridempleados.CurrentRow.Index).Value & "'"
            Dim comando As New MySqlCommand(agrega, coneccion)
            comando.CommandType = CommandType.Text
            comando.Parameters.AddWithValue("@nombre", TxtNom.Text)
            comando.ExecuteNonQuery()
            coneccion.Close()
            MsgBox("Modificado Corectamente", vbInformation, "Jefes Inmediatos")
            consultar("select * from jefes")

        Catch ex As Exception
            MsgBox(" La modificacion fallo...", MsgBoxStyle.Critical, "Error del Sistema")
            coneccion.Close()
        End Try
    ...
    Public Sub generarestructura()
        ...
        Gridempleados.Columns("nombre").HeaderText = "      Jefe Inmediato"
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Try
            ...
            Dim dset As New DataSet
            Dim dadaptador As New MySqlDataAdapter
            dadaptador.SelectCommand = New MySqlCommand("select count(jefe_inmediato) from colaborador where jefe_inmediato='" & Gridempleados.Item(0, Gridempleados.CurrentRow.Index).Value & "'", coneccion)
            dadaptador.Fill(dset)
            coneccion.Close()
        ...
        If MsgBox("Estas Seguro de Eliminar ¡??", MsgBoxStyle.OkCancel, "Confirmación") = MsgBoxResult.Ok Then
            If seborra = 0 Then
                Try
                    ...
                    coneccion.Open()
                    'nueva forma de agregar
                    Dim agrega As String = "delete from jefes where id='" & Gridempleados.Item(0, Gridempleados.CurrentRow.Index).Value & "'"
                    Dim comando As New MySqlCommand(agrega, coneccion)
                    comando.CommandType = CommandType.Text
                ...
                End Try
            Else
                MsgBox(" No se puede Eliminar devido a que exiten colaboradores con este Jefe regisrado" & Chr(13) & "SUGERENCIA: Intenta modificar el nombre del jefe...", MsgBoxStyle.Critical, "Error del Sistema")
            End If
        End If
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        Try
            ...
            coneccion.Open()
            'nueva forma de agregar
            Dim agrega As String = "insert into jefes values(default,@nombre)"
            Dim comando As New MySqlCommand(agrega, coneccion)
            comando.CommandType = CommandType.Text
