...
Public Class puestos
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            ...
            Dim agrega As String = "update puestos set descripcion=@nombre where id='" & Gridempleados.Item(0, Gridempleados.CurrentRow.Index).Value & "'"
            Dim comando As New MySqlCommand(agrega, coneccion)
            comando.CommandType = CommandType.Text
            comando.Parameters.AddWithValue("@nombre", TxtNom.Text)
            comando.ExecuteNonQuery()
            coneccion.Close()
            MsgBox("Modificado Corectamente", vbInformation, "Puestos")
            consultar("select * from puestos")
    ...
    Public Sub generarestructura()
        ...
        Gridempleados.Columns("descripcion").HeaderText = "Descripcion de Puestos"
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Try
            ...
            Dim dset As New DataSet
            Dim dadaptador As New MySqlDataAdapter
            dadaptador.SelectCommand = New MySqlCommand("select count(puesto) from colaborador where puesto='" & Gridempleados.Item(0, Gridempleados.CurrentRow.Index).Value & "'", coneccion)
            dadaptador.Fill(dset)
            coneccion.Close()
        ...
        If MsgBox("Estas Seguro de Eliminar", MsgBoxStyle.OkCancel, "Confirmación") = MsgBoxResult.Ok Then
            If seborra = 0 Then
                Try
                    ...
                    coneccion.Open()
                    'nueva forma de agregar
                    Dim agrega As String = "delete from puestos where id='" & Gridempleados.Item(0, Gridempleados.CurrentRow.Index).Value & "'"
                    Dim comando As New MySqlCommand(agrega, coneccion)
                    comando.CommandType = CommandType.Text
                ...
                End Try
            Else
                MsgBox(" No se puede Eliminar devido a que exiten colaboradores con este puesto regisrado" & Chr(13) & "SUGERENCIA: Intenta modificar el nombre del puesto...", MsgBoxStyle.Critical, "Error del Sistema")
            End If
        End If
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        Try
            ...
            coneccion.Open()
            'nueva forma de agregar
            Dim agrega As String = "insert into puestos values(default,@nombre)"
            Dim comando As New MySqlCommand(agrega, coneccion)
            comando.CommandType = CommandType.Text
